 ...
 * @returns {Object}
 */
export function extendRootConfigWithNgSelectors(params) {
    return [
        ...ROOT_CONFIG,
        {
            files: ['**/*.ts'],
            rules: getAngularSelectorsRules({
                component: [...DEFAULT_COMPONENT_SELECTORS, ...(params?.component ?? [])],
                directive: [...DEFAULT_DIRECTIVE_SELECTORS, ...(params?.directive ?? [])],
            })
        }
    ]
}
